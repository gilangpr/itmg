		...
		c.up().add({
            ...
            items:[{
                ...
                tbar:[{
                	...
                	listeners:{
                		click:function(){
                			var mmc = Ext.getCmp('meeting-contact-list-' + __id);
            ...
            },
            {
            	...
            	xtype:'gridpanel',
                store:storeMP,
                id:'meetingparticipant-list-'+__id,
            	autoScroll:true,
            	minHeight:200,
            	maxWidth: Ext.getBody().getViewSize().width - maxWidth,
                columns:[{
            	...
            	tbar:[{
            		...
            		listeners:{
            			click:function(){
                            var mmp = Ext.getCmp('meetingparticipant-list-' + __id);
            	...
            	region:'north',
            	xtype:'gridpanel',
                id: 'meetingdocumentation-list-' + __id,
                store:storeMD,
            	autoScroll:true,
            	minHeight:200,
            	maxWidth: Ext.getBody().getViewSize().width - maxWidth,
            	tbar:[{
            		...
            		listeners:{
            			click:function(){
                            var mmd = Ext.getCmp('meetingdocumentation-list-' + __id);
            		...
            		listeners:{
            			click:function(){
                            var  md= Ext.getCmp('meetingdocumentation-list-'+__id);
                ...
                items: [{
                    ...
                    border: false,
                    bodyPadding: '5 5 5 5',
                    id: 'meeting-detail-notes-form-' + __id,
                    items: [{
                        xtype: 'textarea',
                        name: 'NOTES',
                    ...
                    buttons: [{
                        ...
                        listeners: {
                            click: function() {
                                ...
                                var form = Ext.getCmp('meeting-detail-notes-form-' + __id).getForm();
                                if(form.isValid()) {
                                    form.submit({
